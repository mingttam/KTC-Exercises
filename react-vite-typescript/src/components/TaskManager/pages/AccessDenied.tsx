  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-indigo-400 to-purple-600 text-white font-sans">
      <div className="flex flex-col items-center animate-fade-in">
        ...
        <p className="text-lg mb-8 max-w-md text-center text-gray-200">
        ...
        <button
          ...
          className="px-8 py-3 text-lg font-semibold rounded-full bg-gradient-to-r from-indigo-400 to-purple-600 shadow-lg hover:scale-105 hover:shadow-2xl transition-all duration-200 outline-none focus:ring-2 focus:ring-white"
        >
          Quay về Login
        </button>
      </div>
